...
struct ProductDataWrapper: Decodable {
    let productCellData: [ProductCellData]
}

struct ProductCellData: Identifiable, Decodable {
    var id: String = UUID().uuidString  // Auto-generates a unique ID
